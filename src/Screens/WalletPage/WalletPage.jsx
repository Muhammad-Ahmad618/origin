    ...
    <div className="relative">
      ...
      <div className="max-w-screen-2xl min-h-screen pt-34 pb-10 text-white mx-auto px-5 lg:px-24">
        ...
        <div className="max-w-screen-2xl min-h-screen pt-34 pb-10 text-white mx-auto px-5 lg:px-24">
          <PageHeader
            title="My Wallet"
            description="Manage your account balance, transactions, and payment methods"
          />
          <div className="my-10 space-y-2">
            <h3 className="text-[1.5rem] font-medium">Account balance</h3>
            <p className="text-gray-400">
            ...
            <div className="basis-[40%]">
              ...
              <div className="my-5 flex items-center flex-wrap-reverse gap-5">
                ...
                <CustomButton
                  label="Add Funds"
                  icon={<FaPlus />}
                  styling="bg-gradient-to-r from-purple-600 to-purple-800 transition-all duration-300 ease-in-out rounded-md py-3 hover:opacity-80 "
                />
              </div>
            </div>
            ...
            <div className="basis-[60%]">
              <div className="space-y-2">
                ...
                <p className="text-gray-400">
                  ...
                  be set as the default for all purchases made using your Games
                  Account on PC and mobile, including purchases on the Origin
                  Games Store.
                </p>
              </div>
                ...
                <div>
                  <div
                    ...
                    className={`bg-white/5 p-4 my-5 rounded-md border cursor-pointer ${
                      isOpen.tab1
                        ? "min-h-fit border-purple-300"
                        : "h-[3.5rem] border-white/20"
                    } overflow-hidden`}
                  >
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                      ...
                      <p className="text-[0.8rem] my-3 leading-6 font-medium">
                        By saving your payment information, this payment method
                        will be set as the default for all purchases made using
                        your Epic Games Account on PC and mobile. You can delete
                        your saved payment information anytime on this payment
                        screen or by logging in to your Epic Games Account and
                        selecting payment management in your account setting.
                      </p>
                      <div className="my-5">
                        <input
                          type="submit"
                  ...
                  <div
                    className={`bg-white/5 p-4 my-5 rounded-md border ${
                      isOpen.tab2
                        ? "min-h-fit border-purple-400"
                        : "h-[3.5rem] border-white/20 "
                  ...
                  >
                    ...
                    <div className="mt-5 space-y-3">
                      <p className="text-xs font-medium leading-6">
                        ...
                        your saved payment information anytime on this payment
                        screen or by logging in to your Epic Games Account and
                        selecting payment management in your account settings.
                      </p>
