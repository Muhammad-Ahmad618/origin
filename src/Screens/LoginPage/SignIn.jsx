...
import VortexButton from "../../Components/VortexBtn/VortexButton";
...
import AuthenticationSlider from "../../Components/AuthenticationSlider/AuthenticationSlider";
...
export default function SignIn({ heading }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-black to-purple-800 ">
      <div
        className={`min-h-screen w-full bg-custom-black-80 gap-y-10 absolute z-10 ${splashScreen ? "flex flex-col justify-center items-center" : "hidden"
          }`}
      >
      ...
      <div className="flex justify-center items-center flex-col h-screen py-10">
        <nav className="flex justify-center items-center px-10">
