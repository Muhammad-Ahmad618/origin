    ...
    <div className="bg-black shadow-sm shadow-black p-4 flex items-center justify-between top-0 fixed w-full z-20">
      ...
      <div className="px-5 sm:px-10 flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-x-8 relative">
          ...
          <div
            className={`w-[19rem] h-[30rem] hidden md:block bg-black/60 backdrop-blur-md absolute top-10 right-16 rounded-3xl duration-300 transition-all ease-in-out ${notificationTab ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
              }`}
            ref={notificationRef}
          >
          ...
          <div className="relative">
            ...
            <IoCart className="text-white text-[1.8rem] cursor-pointer hover:text-purple-400" onClick={() => { handleCart() }} />
          </div>
        </div>
