...
export default function Footer() {
  return (
    <div className="bg-black py-5 min-h-[28rem] flex flex-col justify-between mt-14 h-full">
      <div className="flex justify-around items-start gap-y-12 flex-col lg:flex-row pt-0 md:pt-10 h-full">
        <div className="px-5 space-y-5 basis[30%] mt-5  ">
          ...
          <div className="flex items-center flex-wrap gap-5 md:space-y-5 md:block">
            <h4 className="text-white text-sm md:text-[1.2rem] font-medium">
              Follow Us
            </h4>
            <ul className="flex text-white gap-x-7 text-lg md:text-xl xl:text-2xl">
              ...
              <li>
                <FaDiscord className="cursor-pointer hover:text-purple-400" />
              </li>
              <li>
                <BsTwitch className="cursor-pointer hover:text-purple-400" />
              </li>
            </ul>
          </div>
        </div>
