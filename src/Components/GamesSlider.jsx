...
export default function GamesSlider({
  ...
  // Base configuration for both states
  ...
  // Loading state configuration (no loop, no autoplay)
  const loadingConfig = {
    ...baseSwiperConfig,
  };

  // Loaded state configuration (with loop and autoplay)
  const loadedConfig = {
    ...baseSwiperConfig,
    loop: true,
    autoplay: {
                ...
                <div className="aspect-[4/5] animate-pulse">
                  ...
                  <div className="py-3 text-left h-[9rem]">
                    <div className="h-[3rem] space-y-2">
                      <div className="h-4 w-[30%] bg-white/10 rounded-2xl"></div>
                      <div className="h-4 w-full bg-white/10 rounded-2xl"></div>
                    </div>
                    <div className="h-4 w-[20%] bg-white/10 rounded-2xl mt-2"></div>
                  </div>
                </div>
              </SwiperSlide>
            ))}
